The below policies are a requirement for publishing an app in Google Cloud Platform. Feel free to use them when creating your own OAuth app in Google Cloud Platform to run this software.
